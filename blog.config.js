...
const BLOG = {
    ...
    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '万象搜索', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '社畜', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://wxsounb.top', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,wxsounb,万象搜索,万象搜索资源站,墙外资源', // 网站关键词 英文逗号隔开
  
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'webadmin@wxsounb.top', // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/wxsounb', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
    CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/wxsounb', // 你的telegram 地址 例如 https://t.me/tangly_1024
    ...
    BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/public/favicon2.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
    ...
    ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-ND3HQ27W3B', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
    ...
    // 微软 Clarity 站点分析
    CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'mnojkhsy48', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
